        ...
        <div className="flex overflow-x-scroll lg:justify-center  hide-scroll-bar">
          ...
          <div className="flex ">
            ...
            {category.map((item, index) => {
              return (
                <div key={index} className="px-3 lg:px-9">
                  {/* Image  */}
                  <div
                  onClick={()=> navigate(`/category/${item.name}`)}
                  className=" w-16 h-16 lg:w-24 lg:h-24 max-w-xs rounded-full  bg-gray-400 transition-all hover:bg-gray-500 cursor-pointer mb-1 ">
